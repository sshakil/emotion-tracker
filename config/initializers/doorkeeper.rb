...
Doorkeeper.configure do
  ...
  custom_access_token_expires_in do |context|
    context.client.application.additional_settings[:custom_expiration] || 2.hours
  end
...
Doorkeeper::JWT.configure do
  # Use the application's secret key to encode the tokens
  secret_key Rails.application.secret_key_base

  # Encryption method used to encode the tokens
  signing_method :hs256

  # Specify the key to be used for signing JWTs
  # This key must match the public key that the consumers will use to verify the JWT signature
  ...
  #     user: ->(resource_owner) { { id: resource_owner.id, email: resource_owner.email } }
  #   }
  # end
  #
  ...
  #
  #   {
  #     iss: 'MyAPI', # issuer of the token
  #     iat: Time.current.utc.to_i, # issued at time
  #     sub: user.id, # subject - the user id
  #     aud: opts[:application_id], # audience - the application id
